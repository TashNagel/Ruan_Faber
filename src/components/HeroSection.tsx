  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          Olympic medalist & world record holder. Dedicated to pushing the limits of human performance in the water.
        </motion.p>
        ...
        >
          <a
            href="#achievements"
            className="px-8 py-4 font-semibold bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all duration-300 glow-aqua"
          >
            View Achievements
          </a>
          <a
            href="#contact"
            className="px-8 py-4 font-semibold border border-primary/50 text-foreground rounded-lg hover:bg-primary/10 transition-all duration-300"
          >
            Get in Touch
          </a>
        </motion.div>
